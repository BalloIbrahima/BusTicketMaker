      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="${pageContext.request.contextPath}/pages/dashboard/index.jsp">
            ...
            <span class="nav-link-text ms-1">Creer  un nouveau billet</span>
          </a>
        </li>
         <li class="nav-item">
          <a class="nav-link text-white active" href="${pageContext.request.contextPath}/pages/dashboard/newBillet.jsp">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Nouveau billet</li>
                </ol>
     ...
     <div class=" ps-5 pe-4 pb-5" >
     	...
     	<div class="container mt-5 mb-5 d-flex justify-content-center">
		    <form class="card px-1 py-4" method="post" action="${pageContext.request.contextPath}/newBillet">
		        <div class="card-body">
		            <h6 class="card-title mb-3">Ajouter un nouveau billet !</h6>
		            <div class="row">
		                <div class="col-sm-12">
		           ...
		           <%} %>
		            ...
		            <div class=" d-flex flex-column text-center px-5 mt-3 mb-3"> <small class="agree-text">Remplissez les champs et </small> <a href="#" class="terms">Validez</a> </div> <button class="btn btn-primary btn-block confirm-button" type='submit' name="creerbtn" value="creer">Valider</button>
		        </div>
		    </form>
		</div>
     </div>
